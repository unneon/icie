...
#[evscode::config(
	description = "[UNFINISHED FEATURE] The path to library.json generated by https://github.com/pustaczek/likeeper. It will be used to quickly paste parts of your competitive \
	               programming library using Alt+[."
)]
