...
pub struct Events {
	...
	pub report_action_show: Counter,
	pub report_action_click: Counter,
	pub report: Counter,
	pub report_tutorial: Counter,
	pub report_page: Counter,
...
pub const TELEMETRY: Events = Events {
	...
	report_action_show: Counter::new("action.report_action_show"),
	report_action_click: Counter::new("action.report_action_click"),
	report: Counter::new("action.report"),
	report_tutorial: Counter::new("action.report_tutorial"),
	report_page: Counter::new("action.report_page"),
