...
extern "C" {
	...
	pub fn send_telemetry_event(this: &default, event_name: &str, properties: &JsValue, measurements: &JsValue);

	#[wasm_bindgen(method, js_name = sendTelemetryException)]
	pub fn send_telemetry_exception(this: &default, error: &js_sys::Error, properties: &JsValue, measurements: &JsValue);
